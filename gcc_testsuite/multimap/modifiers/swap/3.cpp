...
int test01() {
    ...
    my_mmap mmap02(std::less<char>(), alloc02);
    size02 = mmap02.size();
    ...
    my_mmap mmap03(std::less<char>(), alloc02);
    size01 = mmap03.size();
    ...
    my_mmap mmap06(mmap02_ref.begin(), mmap02_ref.end(), std::less<char>(), alloc02);
    size02 = mmap06.size();
    ...
    my_mmap mmap07(mmap01_ref.begin(), mmap01_ref.end(), std::less<char>(), alloc02);
    size01 = mmap07.size();
    ...
    my_mmap mmap10(mmap04_ref.begin(), mmap04_ref.end(), std::less<char>(), alloc02);
    size02 = mmap10.size();
    ...
    my_mmap mmap11(mmap04_ref.begin(), mmap04_ref.end(), std::less<char>(), alloc02);
    size01 = mmap11.size();
    ...
    my_mmap mmap14(mmap03_ref.begin(), mmap03_ref.end(), std::less<char>(), alloc02);
    size02 = mmap14.size();
