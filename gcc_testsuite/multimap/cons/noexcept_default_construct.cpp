...
using mtype1 = uxs::multimap<int, int>;
...
using mtype2 = uxs::multimap<int, int, cmp>;
...
using mtype3 = uxs::multimap<int, int, std::less<int>, not_noexcept_cons_alloc<std::pair<const int, int>>>;
