...
int test03() {
    ...
    typedef propagating_allocator<std::pair<const int, int>, false, tracker_allocator<std::pair<const int, int>>>
        alloc_type;
    typedef uxs::multimap<int, int, std::less<int>, alloc_type> test_type;
