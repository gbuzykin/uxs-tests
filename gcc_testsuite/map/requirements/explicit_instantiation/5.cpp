...
// libstdc++/50118
template class uxs::map<int, int, std::less<int>, ExplicitConsAlloc<std::pair<const int, int>>>;
#if !defined __STRICT_ANSI__ && __cplusplus <= 201703L && !defined _GLIBCXX_CONCEPT_CHECKS
template class uxs::map<int, int, std::less<int>, ExplicitConsAlloc<char>>;
#endif
