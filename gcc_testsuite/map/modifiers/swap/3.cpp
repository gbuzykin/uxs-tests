...
int test01() {
    ...
    my_map map02(std::less<char>(), alloc02);
    size02 = map02.size();
    ...
    my_map map03(std::less<char>(), alloc02);
    size01 = map03.size();
    ...
    my_map map06(map02_ref.begin(), map02_ref.end(), std::less<char>(), alloc02);
    size02 = map06.size();
    ...
    my_map map07(map01_ref.begin(), map01_ref.end(), std::less<char>(), alloc02);
    size01 = map07.size();
    ...
    my_map map10(map04_ref.begin(), map04_ref.end(), std::less<char>(), alloc02);
    size02 = map10.size();
    ...
    my_map map11(map04_ref.begin(), map04_ref.end(), std::less<char>(), alloc02);
    size01 = map11.size();
    ...
    my_map map14(map03_ref.begin(), map03_ref.end(), std::less<char>(), alloc02);
    size02 = map14.size();
