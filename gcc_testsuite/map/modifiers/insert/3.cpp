...
int test01() {
    ...
    std::pair<Map::iterator, bool> p = m.insert(Pair(rvalstruct(1), rvalstruct(3)));
    VERIFY(p.second);
    VERIFY(m.size() == 1);
...
int test02() {
    ...
    std::pair<Map::iterator, bool> p1 = m.insert(Pair(rvalstruct(2), rvalstruct(3)));
    std::pair<Map::iterator, bool> p2 = m.insert(Pair(rvalstruct(2), rvalstruct(7)));
