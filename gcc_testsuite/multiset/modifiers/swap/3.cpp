...
int test01() {
    ...
    my_multiset mset02(std::less<char>(), alloc02);
    size02 = mset02.size();
    ...
    my_multiset mset03(std::less<char>(), alloc02);
    size01 = mset03.size();
    ...
    my_multiset mset06(title02, title02 + N2, std::less<char>(), alloc02);
    size02 = mset06.size();
    ...
    my_multiset mset07(title01, title01 + N1, std::less<char>(), alloc02);
    size01 = mset07.size();
    ...
    my_multiset mset10(title04, title04 + N4, std::less<char>(), alloc02);
    size02 = mset10.size();
    ...
    my_multiset mset11(title04, title04 + N4, std::less<char>(), alloc02);
    size01 = mset11.size();
    ...
    my_multiset mset14(title03, title03 + N3, std::less<char>(), alloc02);
    size02 = mset14.size();
