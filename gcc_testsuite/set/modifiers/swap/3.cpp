...
int test01() {
    ...
    typedef uxs::set<char, std::less<char>, my_alloc> my_set;
    ...
    const uxs::set<char> set01_ref(title01, title01 + N1);
    const uxs::set<char> set02_ref(title02, title02 + N2);
    const uxs::set<char> set03_ref(title03, title03 + N3);
    const uxs::set<char> set04_ref(title04, title04 + N4);
    ...
    my_set set01(std::less<char>(), alloc01);
    size01 = set01.size();
    personality01 = set01.get_allocator().get_personality();
    my_set set02(std::less<char>(), alloc02);
    size02 = set02.size();
    ...
    my_set set03(std::less<char>(), alloc02);
    size01 = set03.size();
    personality01 = set03.get_allocator().get_personality();
    my_set set04(title02, title02 + N2, std::less<char>(), alloc01);
    size02 = set04.size();
    personality02 = set04.get_allocator().get_personality();

    set03.swap(set04);
    VERIFY(set03.size() == size02);
    VERIFY(std::equal(set03.begin(), set03.end(), set02_ref.begin()));
