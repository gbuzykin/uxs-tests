...
ADD_TEST_CASE("", "vector", test_default_ctor_exception_gurantee);
ADD_TEST_CASE("", "vector", test_copy_ctor_exception_gurantee);
ADD_TEST_CASE("", "vector", test_assignment_operator_1);
ADD_TEST_CASE("", "vector", test_assignment_operator_2);
ADD_TEST_CASE("", "vector", test_assignment_operator_3);
ADD_TEST_CASE("", "vector", test_assignment_operator_3_exception_guarantee);
ADD_TEST_CASE("", "vector", test_fill_assign_1);
ADD_TEST_CASE("", "vector", test_fill_assign_2);
ADD_TEST_CASE("", "vector", test_fill_assign_3);
ADD_TEST_CASE("", "vector", test_fill_assign_3_exception_guarantee);
ADD_TEST_CASE("", "vector", test_fill_assign_4);
ADD_TEST_CASE("", "vector", test_range_assign_1);
ADD_TEST_CASE("", "vector", test_range_assign_2);
ADD_TEST_CASE("", "vector", test_range_assign_3);
ADD_TEST_CASE("", "vector", test_range_assign_4);
ADD_TEST_CASE("", "vector", test_range_assign_4_exception_guarantee);
