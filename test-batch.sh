...
C_COMPILER=clang-18 CXX_COMPILER=clang++-18 CXX_STD=11 ./test.sh
C_COMPILER=clang-18 CXX_COMPILER=clang++-18 CXX_STD=14 ./test.sh
C_COMPILER=clang-18 CXX_COMPILER=clang++-18 CXX_STD=17 ./test.sh
C_COMPILER=clang-18 CXX_COMPILER=clang++-18 CXX_STD=20 ./test.sh
C_COMPILER=clang-18 CXX_COMPILER=clang++-18 CXX_STD=23 ./test.sh
C_COMPILER=clang-18 CXX_COMPILER=clang++-18 UCXX_STD=20 BUILD_TYPE=Release ./test.sh
...
C_COMPILER=clang-18 CXX_COMPILER=clang++-18 USE_LIBCPP=ON CXX_STD=20 BUILD_TYPE=Release ./test.sh
