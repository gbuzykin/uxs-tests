...
int test_string_utf_0() {
    ...
    VERIFY(ch[0] == '\x7E');
    VERIFY(uxs::from_utf8(ch, (char*)ch, p, code) == 0);
    ...
    VERIFY(ch[1] == '\xBC');
    VERIFY(ch[2] == '\xB8');
    VERIFY(uxs::from_utf8(ch, (char*)ch + 2, p, code) == 1 && p == (char*)ch + 1);
    ...
    VERIFY(ch[2] == '\xBC');
    VERIFY(ch[3] == '\xB8');
    VERIFY(uxs::from_utf8(ch, (char*)ch + 3, p, code) == 1 && p == (char*)ch + 1);
...
int test_string_utf_1() {
    ...
    VERIFY(uxs::from_utf16(ch, (wchar_t*)ch, p, code) == 0);
