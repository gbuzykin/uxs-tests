...
int test_insert_to_empty() {
...

    {
        ...
        VERIFY(al.get_alloc_detected() == v.capacity());
        //  insert empty mid
        it = v.insert(v.begin() + 3, ins.begin(), ins.begin());
        VERIFY(it == v.begin() + 3);
        CHECK(v, 3, tst);
        VERIFY(v.capacity() >= v.size());
        VERIFY(T::instance_count == (std::is_same<typename Src::value_type, Ty>::value ? 6 : 3));
...
int test_insert_to_empty_random_access_range_assignable() { return test_insert_to_empty<T, uxs::vector<T>>(); }
...
int test_insert_to_empty_generic_input_range_assignable() { return test_insert_to_empty<T, uxs::list<T>>(); }
...
int test_insert_to_empty_random_access_range_not_assignable() { return test_insert_to_empty<T, uxs::vector<int>>(); }
...
int test_insert_to_empty_generic_input_range_not_assignable() { return test_insert_to_empty<T, uxs::list<int>>(); }
...
ADD_TEST_CASE("", "vector", test_insert_to_empty_random_access_range_assignable);
...
ADD_TEST_CASE("", "vector", test_insert_to_empty_generic_input_range_assignable);
...
ADD_TEST_CASE("", "vector", test_insert_to_empty_random_access_range_not_assignable);
...
ADD_TEST_CASE("", "vector", test_insert_to_empty_generic_input_range_not_assignable);
