...
ADD_TEST_CASE("", "dynarray", test_emplace_back_to_empty);
ADD_TEST_CASE("", "dynarray", test_emplace_back_no_realloc);
ADD_TEST_CASE("", "dynarray", test_emplace_back_needs_realloc_nothrow_move);
ADD_TEST_CASE("", "dynarray", test_emplace_back_needs_realloc_throwing_move);
