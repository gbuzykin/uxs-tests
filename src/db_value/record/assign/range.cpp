...
int test_range_empty_to_empty_random_access_range() {
    return test_range_empty_to_empty<uxs::vector<std::pair<std::string_view, std::string_view>>>();
}
int test_range_not_empty_to_empty_random_access_range() {
    return test_range_not_empty_to_empty<uxs::vector<std::pair<std::string_view, std::string_view>>>();
}
int test_range_more_random_access_range() {
    return test_range_more<uxs::vector<std::pair<std::string_view, std::string_view>>>();
}
int test_range_less_random_access_range() {
    return test_range_less<uxs::vector<std::pair<std::string_view, std::string_view>>>();
}
int test_range_same_amount_random_access_range() {
    return test_range_same_amount<uxs::vector<std::pair<std::string_view, std::string_view>>>();
}
int test_range_empty_to_not_empty_random_access_range() {
    return test_range_empty_to_not_empty<uxs::vector<std::pair<std::string_view, std::string_view>>>();
}
